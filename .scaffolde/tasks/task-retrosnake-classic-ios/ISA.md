...
- ISC-2/TestFlight latest: App Store Connect shows build 1.0 (4) upload **Complete** and the **Voxel Snake Internal** group shows build 4 **Testing**, with one tester and arena-specific "What to Test" guidance saved. The tester's iPhone 16 Pro still reports build 3 installed. Physical iPhone visual quality, frame rate, heat, and gameplay remain unverified until build 4 is installed and played. Build 1 remains attached to App Review and must not be manually released as the arena app.

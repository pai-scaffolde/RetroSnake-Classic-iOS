...
2. Build the full-resolution arena candidate and assess it in TestFlight for smoothness, heat, launch, swipes, era transitions, pause, Game Over, retry, audio, airplane mode, background recovery, and haptics. The desktop project on Plex is the source for future arena texture imports.
